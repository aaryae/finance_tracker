...
const AnalyticsLineChart = ({ navstate }: { navstate: boolean }) => (
  <>
    <div
      className={`container mx-auto flex flex-wrap   ${navstate ? "" : "justify-center"}`}
    >
      <div className="w-5xl mx-16  bg-[#262626] rounded-3xl overflow-hidden   ">
